...
- **Son aktif CDN hash**: `dcdedaf`

### CMS'deki Aktif Kod

```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/mitobet/style-core@dcdedaf/dist/v1/bundle.css">
<script src="https://cdn.jsdelivr.net/gh/mitobet/style-core@dcdedaf/dist/v1/bundle.js"></script>
```
