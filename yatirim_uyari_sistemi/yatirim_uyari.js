(function() {
    ...
    // URL değişiklik izleme - optimize edilmiş
    function watchURLChanges() {
        ...
        // URL kontrolü - daha az sıklıkta
        setInterval(checkURL, 1000);
        
        // History API override - tek seferlik
    ...
    // DOM değişiklik observer'ı - optimize edilmiş
    function setupDOMObserver() {
        ...
        const observer = new MutationObserver(function(mutations) {
            ...
            for (const mutation of mutations) {
                ...
                // Sadece önemli attribute değişiklikleri
    ...
    // Periyodik kontrol - optimize edilmiş
    function startPeriodicCheck() {
        if (periodicInterval) return;
        
        // Sadece wallet modal açıkken periyodik kontrol yap
