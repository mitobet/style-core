...
class PopupManager {
    constructor() {
        this.popup = null;
        this.isOpen = false;
        this.imageUrl = 'https://vendor-provider.fra1.cdn.digitaloceanspaces.com/ebetlab/ep3YGM2vykm19eefqTFkF0LvamjEEULx/mini-sliders/Rw3ObFzdWV82RKcEs063AMyCZUsXWJZ0akH9ybFt.png';
        ...
        const popupHTML = `
            <div id="customPopup" class="popup-overlay">
                <div class="popup-content">
                    ...
                    <img class="popup-image" src="" alt="Popup Image" style="display: none;">
                </div>
            </div>
        `;
    ...
    bindEvents() {
        ...
        // Prevent image click from closing popup
        const img = this.popup.querySelector('.popup-image');
