...
(function() {
    ...
    var RAW_IMG_0 = 'https://vendor-provider.fra1.cdn.digitaloceanspaces.com/ebetlab/GakckagaakasdqGVAEgA/statics/zdxZv7GPdyf6AiQrPKlcWzrzeChzONHATedHdjAn.jpg';
    ...
    var STORIES = [
        {
            avatar: PROXY + encodeURIComponent(RAW_IMG_0) + '&w=120&h=120&fit=cover&output=webp',
            src:    PROXY + encodeURIComponent(RAW_IMG_0) + '&w=720&q=80&output=webp',
